    ...
    return (
        <div>
            ...
            <div style={{
                ...
                textAlign: "left", paddingBottom: "20%",
                backgroundColor: "red"
            }}>
                <h2 style={{ fontSize: "4vw",color:"white" }}>
                    Code and run <br />in you browser
</h2>
                <p style={{ fontSize: "2vw",color:"white" }}>
                    Create, Edit and Save Web, C/CPP Apps
</p>
            </div>
            <div style={{padding:"30px",paddingBottom:"20%",backgroundColor:"rgb(236, 239, 241)"}}>
            ...
            <Link to="/c_cpp" style={{ textDecoration: "none" }}>
                <Button variant="contained" color="primary"   size="large"  style={{margin:"30px",height:"70px",width:"200px"}}>
                    c_cpp
          </Button>
            </Link>
            <br/>
            ...
            <br/>
            <img src={cpp} style={{width:"15%",height:"15%",margin:"50px",}}/>
            <img src={html} style={{width:"15%",height:"15%",margin:"50px"}}/>
            <br/>
            <img src={js} style={{width:"15%",height:"15%",margin:"50px"}}/>
            <img src={css} style={{width:"15%",height:"15%",margin:"50px"}}/>
