      ...
      <CssBaseline>
        ...
        <Switch>
          ...
          <Route
            path="/web/:id"
            component={(props) => (
              <Web handleClickOpen={this.handleClickOpen} {...props}></Web>
            )}
          />
          <Route
            path="/c_cpp"
          ...
          <Route
            path="/web"
            component={() => <Web handleClickOpen={this.handleClickOpen}></Web>}
          />
